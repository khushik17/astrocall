    ...
    return (
        <div style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column" }}>
            ...
            <div style={{ flex: 1, position: "relative", background: "#0a0318", overflow: "hidden" }}>
                ...
                <div style={{
                    position: "absolute",
                    bottom: "clamp(70px, 14vw, 100px)", /* stay above control bar */
                    right: chatOpen ? "clamp(10px, 3vw, 30px)" : "clamp(10px, 3vw, 30px)",
                    ...
                    <div style={{
                        ...
                        background: "rgba(5,2,14,0.75)", borderRadius: 5,
                        padding: "2px 6px",
                    }}>
                        <span style={{
                            fontFamily: "'Cinzel',serif",
            ...
            <div style={{
                ...
                zIndex: 30,
                /* Prevent bar from being wider than screen on tiny phones */
